...
/*   Updated: 2018/07/08 21:17:06 by thile            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_other_line(int x, int y, char c, char d)
{
	int	i;
	int j;
...
void	rush(int x, int y)
{
	...
	if (x > 0 && y > 0)
	{
		...
		print_other_line(x, y, c, d);
		print_last_line(x, y, b, a);
	}
}
