...
/*   Updated: 2018/07/08 21:21:35 by thile            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <unistd.h>

void	print_first_line(int x, char a, char c)
{
	int i;
...
void	print_last_line(int x, int y, char c, char a)
{
	if (y > 1)
	{
		print_first_line(x, c, a);
		ft_putchar('\n');
	}
}
...
void	rush(int x, int y)
{
	...
	if (x > 0 && y > 0)
	{
		print_first_line(x, a, c);
		print_other_line(x, y, b, d);
		print_last_line(x, y, c, a);
	}
}
